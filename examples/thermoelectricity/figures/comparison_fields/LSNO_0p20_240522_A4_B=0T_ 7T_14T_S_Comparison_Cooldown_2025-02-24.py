...
#############################################
fig.text(0.79,0.86, r"LSNO $x$=0.2 A4", ha = "right")
#############################################
...
# 0T //////////////////////////////////////////////////////////////////////////////
######################################################
data = np.loadtxt("../../data_analyzed/LSNO_0p20_240522_A4_Tcooldown_Seebeck_NSYM_B=0T_2025-02-17.txt", dtype="float", comments="#", delimiter=',')
...
# color = '#00EFD0'
index = T_0 > 15
line = axes.plot(T_0[index], S_AC[index]*1e6, label = r"$B$ = 0T")
plt.setp(line, ls ="-", c = color, lw = 2, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################

# 7T //////////////////////////////////////////////////////////////////////////////
######################################################
data = np.loadtxt("../../data_analyzed/LSNO_0p20_240522_A4_Tcooldown_Seebeck_NSYM_B=-7T_2025-02-24.txt", dtype="float", comments="#", delimiter=',')
...
# color = '#00EFD0'
index = T_0 > 15
line = axes.plot(T_0[index], S_AC[index]*1e6, label = r"$B$ = 7T")
plt.setp(line, ls ="-", c = color, lw = 2, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################

# 14T //////////////////////////////////////////////////////////////////////////////
######################################################
data = np.loadtxt("../../data_analyzed/LSNO_0p20_240522_A4_Tcooldown_Seebeck_NSYM_B=14T_2025-02-19.txt", dtype="float", comments="#", delimiter=',')
...
# color = '#00EFD0'
index = T_0 > 13
line = axes.plot(T_0[index], S_AC[index]*1e6, label = r"$B$ = 14T")
plt.setp(line, ls ="-", c = color, lw = 2, marker = "", mfc = color, ms = 7, mec = color, mew= 2)
######################################################
...
#############################################
axes.set_xlim(0,150)   # limit for xaxis
axes.set_ylim(-15,2.5) # leave the ymax auto, but fix ymin
#axes.set_xscale('log')
# axes.set_yscale('log')
axes.set_xlabel(r"$T$ ( K )", labelpad = 8)
axes.set_ylabel(r"$S$ ( $\mu$V / K )", labelpad = 8)
